...
def generate_hyprconf() -> str:
    ...
    return f"""exec-once = $(python {home}/.config/{APP_NAME_CAP}/main.py)
...
bind = {bind_vars['prefix_restart']}, {bind_vars['suffix_restart']}, exec, killall {APP_NAME}; $(python {home}/.config/{APP_NAME_CAP}/main.py) # Reload {APP_NAME_CAP} | Default: SUPER ALT + B
...
bind = {bind_vars["prefix_config"]}, {bind_vars["suffix_config"]}, exec, python {home}/.config/{APP_NAME_CAP}/config/config.py
bind = {bind_vars['prefix_restart_inspector']}, {bind_vars['suffix_restart_inspector']}, exec, killall {APP_NAME}; $(GTK_DEBUG=interactive python {home}/.config/{APP_NAME_CAP}/main.py) # Restart with inspector | Default: SUPER CTRL ALT + B
